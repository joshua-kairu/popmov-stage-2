...
/**
 * A result of searching for trailers. This contains the details for a single trailer.
 */
// begin class Result
public class Result {
     ...
     * @param size
     */
    public Result( String id, String iso6391, String iso31661, String key, String name, String site,
    ...
    public Result withSize( int size ) {
        this.size = size;
        return this;
    }
